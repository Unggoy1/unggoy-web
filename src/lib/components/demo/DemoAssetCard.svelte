<script lang="ts">
  ...
  import BidirectionalPairingModal from './BidirectionalPairingModal.svelte';
  import { DropdownType } from '$lib/enums';
  import { Plus, Link, Duplicate } from '$lib/components/icons';
  
  export let asset: UgcData = undefined;
  export let assetUrl: string;
  
  let dropdown: DropdownCard;
  let pairingModal: BidirectionalPairingModal;
...
<BidirectionalPairingModal bind:this={pairingModal} />
